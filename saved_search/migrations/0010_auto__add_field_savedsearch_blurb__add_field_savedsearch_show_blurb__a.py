...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SavedSearch.blurb'
        db.add_column('saved_search_savedsearch', 'blurb', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'SavedSearch.show_blurb'
        db.add_column('saved_search_savedsearch', 'show_blurb', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'SavedSearch.show_production'
        db.add_column('saved_search_savedsearch', 'show_production', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SavedSearch.blurb'
        db.delete_column('saved_search_savedsearch', 'blurb')

        # Deleting field 'SavedSearch.show_blurb'
        db.delete_column('saved_search_savedsearch', 'show_blurb')

        # Deleting field 'SavedSearch.show_production'
        db.delete_column('saved_search_savedsearch', 'show_production')
    ...
    models = {
        ...
        'saved_search.savedsearch': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['seo.SeoSite']", 'null': 'True'}),
