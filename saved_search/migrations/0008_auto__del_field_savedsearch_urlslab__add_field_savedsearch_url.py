...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SavedSearch.urlslab'
        db.delete_column('saved_search_savedsearch', 'urlslab')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SavedSearch.urlslab'
        db.add_column('saved_search_savedsearch', 'urlslab', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
