...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SavedSearch.url'
        db.delete_column('saved_search_savedsearch', 'url')

        # Adding field 'SavedSearch.url_slab'
        db.add_column('saved_search_savedsearch', 'url_slab', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SavedSearch.url'
        db.add_column('saved_search_savedsearch', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'SavedSearch.url_slab'
        db.delete_column('saved_search_savedsearch', 'url_slab')
