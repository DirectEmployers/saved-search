...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SavedSearch.querystring'
        db.alter_column('saved_search_savedsearch', 'querystring', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))


    def backwards(self, orm):
        
        # Changing field 'SavedSearch.querystring'
        db.alter_column('saved_search_savedsearch', 'querystring', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
