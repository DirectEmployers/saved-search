...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SavedSearch.city'
        db.alter_column('saved_search_savedsearch', 'city', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'SavedSearch.keyword'
        db.alter_column('saved_search_savedsearch', 'keyword', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'SavedSearch.title'
        db.alter_column('saved_search_savedsearch', 'title', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'SavedSearch.country'
        db.alter_column('saved_search_savedsearch', 'country', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'SavedSearch.state'
        db.alter_column('saved_search_savedsearch', 'state', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))


    def backwards(self, orm):
        
        # Changing field 'SavedSearch.city'
        db.alter_column('saved_search_savedsearch', 'city', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        ...
        # Changing field 'SavedSearch.country'
        db.alter_column('saved_search_savedsearch', 'country', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SavedSearch.state'
        db.alter_column('saved_search_savedsearch', 'state', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'saved_search.savedsearch': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keyword': ('django.db.models.fields.CharField', [], {'max_length': '800', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
