...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SavedSearch.site'
        db.add_column('saved_search_savedsearch', 'site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.SeoSite'], null=True), keep_default=False)

        # Removing M2M table for field site on 'SavedSearch'
        db.delete_table('saved_search_savedsearch_site')


    def backwards(self, orm):
        
        # Deleting field 'SavedSearch.site'
        db.delete_column('saved_search_savedsearch', 'site_id')

        # Adding M2M table for field site on 'SavedSearch'
        db.create_table('saved_search_savedsearch_site', (
        ...
        db.create_unique('saved_search_savedsearch_site', ['savedsearch_id', 'seosite_id'])
