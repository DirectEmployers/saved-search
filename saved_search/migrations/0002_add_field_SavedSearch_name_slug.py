...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SavedSearch.name_slug'
        db.add_column('saved_search_savedsearch', 'name_slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SavedSearch.name_slug'
        db.delete_column('saved_search_savedsearch', 'name_slug')
