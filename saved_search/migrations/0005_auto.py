...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field seo_site on 'SavedSearch'
        db.create_table('saved_search_savedsearch_seo_site', (
        ...
        db.create_unique('saved_search_savedsearch_seo_site', ['savedsearch_id', 'seosite_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field seo_site on 'SavedSearch'
        db.delete_table('saved_search_savedsearch_seo_site')
    ...
    models = {
        ...
        'saved_search.savedsearch': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'seo_site': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['seo.SeoSite']", 'null': 'True', 'blank': 'True'}),
